...
namespace _2015147458_MVC.Controllers
{
    public class AdministradorEquipoesController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            AdministradorEquipo genre = _UnityOfWork.AdministradorEquipo.Get(id);
            if (genre == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include = "GenreId,Description")] AdministradorEquipo administradorEquipo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "GenreId,Description")] AdministradorEquipo administradorEquipo)
        {
            if (ModelState.IsValid)
            {
