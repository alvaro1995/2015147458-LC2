...
namespace _2015147458_MVC.Controllers
{
    public class DepartamentoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "GenreId,Description")] Departamento departamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "GenreId,Description")] Departamento departamento)
        {
            if (ModelState.IsValid)
            {
