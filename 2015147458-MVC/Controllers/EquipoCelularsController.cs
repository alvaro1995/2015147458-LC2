...
namespace _2015147458_MVC.Controllers
{
    public class EquipoCelularsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "GenreId,Description")] EquipoCelular equipoCelular)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "GenreId,Description")] EquipoCelular equipoCelular)
        {
            if (ModelState.IsValid)
            {
